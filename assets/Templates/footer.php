        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Realizar llamada</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">¿Ayuda?</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Modulo de plantillas</a></li>
            </ul>
          </div>
